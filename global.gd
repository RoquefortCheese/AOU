...
var modflavors: Dictionary[Modifier, String] = {
	Modifier.DOORPLANT: "Tall white doors are a keystone species in some ecosystems.",
	Modifier.PILLARVINE: "Because vines can always be climbed.",
	Modifier.FASTANOMS: "They're already here.",
	Modifier.FLOATY: "I never saw the logic of a 'floaty jump' being a bad thing.",
	Modifier.MOREANOMS: "What's more fun than combat? More combat!",
	Modifier.SQUASH: "A famous type of gourd.",
	Modifier.STRETCH: "Not a type of gourd of any level of renown.",
	Modifier.REGEN: "Why should you get more chances than they do?",
	Modifier.RUNNING: "Movement too slow? Have you considered just moving faster?",
	...
	Modifier.MOREAMMO: "There is no reason for it to be called a six-shooter.",
	Modifier.ALERTANOMS: "It's not like they have anything else to do.",
	Modifier.TRIPLEJUMP: "DoubleJump was already innovative, but this is revolutionary.",
	Modifier.STROLLING: "A walk in the park.",
	Modifier.SNIPER: "Multitasking!",
	Modifier.SILVERLINE: "A kill is a kill.",
	Modifier.FULLHEAL: "As all heals should be.",
	Modifier.HIGHGRASS: "Wait, how does this work if anomalies don't use sight anyway?",
	Modifier.DENSE: "A floaty jump is the worst sin a platformer can commit.",
	Modifier.FALLDAMAGE: "Realism in gaming.",
	Modifier.SQUISH: "Have you ever been in a parking garage?",
	Modifier.HYPERSPICE: "So called because it makes combat hyper spicy.",
	...
	Modifier.LESSCHARGE: "Back in my day, we didn't have public transit.",
	Modifier.VENGEANCE: "This is what Batman does, or something.",
	Modifier.COMBO: "Aura always increases your odds of survival.",
	Modifier.DARKNESS: "It's basically a horror game now. (It isn't.)",
	Modifier.AIRJUMP: "Look, conservation of momentum was never an issue before.",
	Modifier.TUNNELS: "This is probably more accurate to actual caves.",
	Modifier.GLASS: "This would be so cool to see in real life.",
	Modifier.BOXCAVE: "It was a lie all along.",
	Modifier.RUBBER: "Whee!",
	Modifier.LESSAMMO: "It's called a six-shooter for a reason.",
}
